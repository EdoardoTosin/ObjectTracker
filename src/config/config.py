...
DEFAULT_RECORDING_DURATION = 30  # Duration (in seconds) to continue recording after the last detection
DEFAULT_BUFFER_SIZE = 50         # Number of frames to buffer before initiating recording
DEFAULT_RECONNECT_INTERVAL = 5   # Interval (in seconds) to wait before attempting to reconnect the camera
...
objects_to_detect = parse_objects_string(user_config.get("objects_to_detect", DEFAULT_OBJECTS_TO_DETECT))
